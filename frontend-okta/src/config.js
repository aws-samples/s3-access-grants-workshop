...
const ISSUER = process.env.ISSUER || 'https://dev-12345678.okta.com/oauth2/aush24dg45GEHoewv5d7';
...
let REDIRECT_URI = `https://abcdef12345678.cloudfront.net/login/callback`;
if (isLocalhost){
    // This URL can be used when testing locally
    REDIRECT_URI = 'http://localhost:3000/login/callback';
}
// API Gateway endpoint deployed by CDK
export const api_endpoint = "https://abc123def4.execute-api.us-east-1.amazonaws.com/prod/";
